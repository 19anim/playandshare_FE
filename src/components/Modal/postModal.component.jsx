  ...
  return (
    <dialog ref={modalRef} className="modal text-black">
      <div className="modal-box max-w-screen md:w-[700px] w-[95%] p-0">
        <div className="h-full bg-[#252728] text-[#e2e5e9] flex flex-col gap-3">
          ...
          <fieldset className="fieldset border-t-1 border-[#393939] w-full bg-[#252728] p-4 pb-5 sticky bottom-0 grid grid-cols-[auto_1fr]">
            <div className="avatar">
              <div className="size-12 rounded-full">
                <img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" />
              </div>
